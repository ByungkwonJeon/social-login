 ...
 * {@link Jwt}-encoded access token, returning its claims set as part of the {@link Authentication}
 * statement.
 * <p>
 * <p>
 * Scopes are translated into {@link GrantedAuthority}s according to the following algorithm:
 * <p>
 * 1. If there is a "scope" or "scp" attribute, then if a {@link String}, then split by spaces and
 * return, or if a {@link Collection}, then simply return 2. Take the resulting {@link Collection}
 * of {@link String}s and prepend the "SCOPE_" keyword, adding as {@link GrantedAuthority}s.
 *
 ...
 * @since 5.1
 */
public final class MyJwtAuthenticationProvider implements AuthenticationProvider {
